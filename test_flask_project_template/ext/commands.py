...
from test_flask_project_template.ext.auth import create_user
from test_flask_project_template.ext.database import db
from test_flask_project_template.models import Product

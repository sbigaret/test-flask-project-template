...
original_author="sbigaret"
original_name="test_flask_project_template"
original_urlname="test-flask-project-template"
original_description="Awesome test_flask_project_template created by sbigaret" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/test_flask_project_template "${name}"
...
then
    ...
    echo "then run 'test_flask_project_template' or 'python -m test_flask_project_template'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'test_flask_project_template' or 'python -m test_flask_project_template' or 'poetry run test_flask_project_template'"
fi

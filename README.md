...
- 🎯 Entry points to execute your program using `python -m <test_flask_project_template>` or `$ test_flask_project_template` with basic CLI argument parsing.
...
---
# test_flask_project_template Flask Application

Awesome test_flask_project_template created by sbigaret
...
```bash
git clone https://github.com/sbigaret/test-flask-project-template test_flask_project_template
cd test_flask_project_template
make install
```
...
```bash
pip install test_flask_project_template
```
...
```bash
$ test_flask_project_template
```

or

```bash
$ python -m test_flask_project_template
```
...
```bash
test_flask_project_template create-db   # run once
test_flask_project_template populate-db  # run once (optional)
test_flask_project_template add-user -u admin -p 1234  # ads a user
test_flask_project_template run
```
